...
if command -v vercel &> /dev/null; then
    ...
    vercel env add NEXTAUTH_URL "https://rupomoti.com" production
    ...
    echo "1. Visit: https://rupomoti.com/api/health?data=true"
    echo "2. Check homepage: https://rupomoti.com"
    echo "3. Test login: https://rupomoti.com/signin"
