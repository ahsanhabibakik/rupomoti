...
const HeroSection = dynamic(() => import('@/components/home/HeroSection'), {
  loading: () => (
    <div className="h-[60vh] animate-pulse bg-muted"></div>
  )
})
  ...
  loading: () => (
    <div className="container mx-auto px-4 py-12">
      <div className="animate-pulse space-y-4">
        ...
        <div className="h-12 bg-muted rounded w-full max-w-md mx-auto"></div>
      </div>
    </div>
  )
})
...
export default function HomePage() {
  ...
  return (
    <>
      <Suspense fallback={<div className="h-[60vh] animate-pulse bg-muted"></div>}>
        <HeroSection />
      </Suspense>
